...
import com.anuravi98.pharmacybillingsystem.service.billing.components.Block;
...
import com.anuravi98.pharmacybillingsystem.service.billing.components.Board;
import com.anuravi98.pharmacybillingsystem.service.billing.components.Table;
...
public class BillCreater {
     ...
     */
    public BillCreater(User user, String customerName, String customerEmail, String billNo, List<List<String>> items,
                       double total) {
        this.user = user;
